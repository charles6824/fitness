...
export const updateUserProfile = (user) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.put(`http://localhosst:5000/api/users/profile`, user, config)
...
export const listIssues = (pageNumber = '') => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.get(`http://localhost:5000/api/contact/all?pageNumber=${pageNumber}`, config)
